...
<div class="profile-container">
    ...
    <?php if(session('success')): ?>
        <div style="background: linear-gradient(135deg, #d4edda 0%, #c8e6c9 100%); color: #155724; border: 2px solid #81c784; padding: 1rem 1.5rem; border-radius: 12px; margin-bottom: 1.5rem; display: flex; align-items: center; gap: 1rem; box-shadow: 0 3px 12px rgba(76, 175, 80, 0.15);">
            ...
            <span style="font-weight: 600; font-size: 0.95rem;"><?php echo e(session('success')); ?></span>
        </div>
    <?php endif; ?>
        ...
        <aside class="profile-sidebar">
            <div class="profile-setting-avatar-wrapper">
                <div class="profile-setting-avatar">
                    <?php if(auth()->user()->foto): ?>
                        <img src="<?php echo e(asset(auth()->user()->foto)); ?>" alt="<?php echo e(auth()->user()->nama_lengkap); ?>">
                    <?php else: ?>
                        <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(auth()->user()->nama_lengkap)); ?>&background=047857&color=fff&size=240" alt="<?php echo e(auth()->user()->nama_lengkap); ?>">
                    <?php endif; ?>
                </div>
            </div>
            
            <div class="profile-setting-name">
                <h2><?php echo e(auth()->user()->nama_lengkap); ?></h2>
            ...
            <div class="profile-details">
                ...
                <div class="detail-row">
                    ...
                    <span><?php echo e(auth()->user()->no_telp ?? '-'); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-icon"><i class="fas fa-map-marker-alt"></i></span>
                    <span><?php echo e(auth()->user()->alamat ? (auth()->user()->alamat . (auth()->user()->kabupaten ? ', ' . auth()->user()->kabupaten : '')) : 'Belum diisi'); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-icon"><i class="fas fa-calendar-alt"></i></span>
                    <span>Sejak <?php echo e(auth()->user()->created_at->format('F Y')); ?></span>
                </div>
            </div>

            <div class="profile-actions">
                <a href="<?php echo e(route('profil.edit')); ?>" class="btn btn-edit-profile">
            ...
            <div class="land-info-card">
                ...
                <?php if(auth()->user()->luas_lahan || auth()->user()->jenis_tanaman): ?>
                    <div class="land-detail">
                        <div class="land-label">Luas Lahan</div>
                        <div class="land-value"><?php echo e(auth()->user()->luas_lahan ?? '-'); ?> Ha</div>
                    </div>
                    <?php if(auth()->user()->jenis_tanaman): ?>
                    <div class="land-detail">
                        ...
                        <div class="commodity-list">
                            ...
                            ?>
                            <?php $__currentLoopData = $tanamanArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tanaman): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="commodity-tag commodity-<?php echo e(strtolower(trim($tanaman))); ?>"><?php echo e(trim($tanaman)); ?></span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                    <?php endif; ?>
                    <?php if(auth()->user()->lokasi_lahan): ?>
                    <div class="land-detail">
                        <div class="land-label">Lokasi Lahan</div>
                        <div class="land-value" style="font-size: 0.8rem;"><?php echo e(auth()->user()->lokasi_lahan); ?></div>
                    </div>
                    <?php endif; ?>
                <?php else: ?>
        ...
        <main class="profile-main-content">
            ...
            <div class="stats-grid">
                <div class="stat-card purple">
                    ...
                    <div class="stat-value"><?php echo e($totalPesanan); ?></div>
                ...
                <div class="stat-card blue">
                    ...
                    <div class="stat-value"><?php echo e(number_format($pupukDiterima, 0)); ?> Kg</div>
                ...
                <div class="stat-card orange">
                    ...
                    <div class="stat-value"><?php echo e(number_format($bibitDiterima, 0)); ?> Kg</div>
                ...
                <div class="stat-card green">
                    ...
                    <div class="stat-value">Rp <?php echo e(number_format($totalPenghematan / 1000, 1)); ?>Jt</div>
            ...
            <div class="orders-section">
                                ...
                                <tr>
                                    <td>
                                        <div class="order-product">
                                            ...
                                            ?>
                                            <div class="product-icon-small <?php echo e($tipeProduk); ?>">
                                                <i class="fas fa-<?php echo e($tipeProduk === 'pupuk' ? 'box' : 'seedling'); ?>"></i>
                                            </div>
                                            <div class="product-details">
                                                <h4><?php echo e($namaProduk); ?></h4>
                                                <p><?php echo e(ucfirst($tipeProduk)); ?></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td><?php echo e($order->quantity); ?> Kg</td>
                                    <td>
                                        <span class="order-price">Rp <?php echo e(number_format($order->total_amount, 0, ',', '.')); ?></span>
                                    </td>
                                    <td>
                                        <?php
                                        ...
                                        ?>
                                        <span class="status-badge <?php echo e($statusClass); ?>"><?php echo e($order->status); ?></span>
                                    </td>
                                    <td>
                                        <a href="<?php echo e(route('user.orders.detail', $order->id)); ?>" class="btn-detail">
                ...
                <?php else: ?>
                    <div class="empty-state">
                        ...
                        <a href="<?php echo e(route('pupuk.bibit')); ?>" class="btn-browse">
    ...
    function confirmDeleteAccount() {
        if (confirm('⚠️ PERINGATAN!\n\nApakah Anda yakin ingin menghapus akun?\n\nSemua data Anda akan dihapus secara permanen dan tidak dapat dikembalikan:\n• Profil dan informasi pribadi\n• Riwayat pesanan\n• Data lahan\n• Pesan dan notifikasi\n\nKetik "HAPUS" untuk melanjutkan.')) {
            ...
            if (confirmation === 'HAPUS') {
                ...
                form.method = 'POST';
                form.action = '<?php echo e(route("account.delete")); ?>';
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ppw10\Project-SistemInformasiPupuk\resources\views/user/ProfilUser.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <title>Step 1: Input Email - Reset Password</title>
    ...
    <script>
        ...
        function sendCode() {
            ...
            .then(data => {
                ...
                if (data.message === 'Kode verifikasi telah dikirim') {
...
<?php /**PATH C:\laragon\www\Project-SistemInformasiPupuk\resources\views/auth/reset-password-email.blade.php ENDPATH**/ ?>
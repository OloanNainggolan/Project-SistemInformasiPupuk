<?php $__env->startSection('title', 'Edit Profil - Pupuk & Bibit Subsidi'); ?>
...
<div class="edit-profile-wrapper">
    ...
    <form id="editProfilForm" action="<?php echo e(route('profil.update')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-grid">
            ...
            <div class="photo-card">
                <div class="photo-preview-wrapper">
                    <?php if($user->foto): ?>
                    <img src="<?php echo e(asset($user->foto)); ?>" alt="Foto Profil" id="photoPreview" class="photo-preview">
                    <?php else: ?>
                    <div class="photo-placeholder" id="photoPlaceholder">
                        <?php echo e(strtoupper(substr($user->nama_lengkap ?? 'U', 0, 2))); ?>

                    </div>
                    <?php endif; ?>
                </div>

                <div class="user-name"><?php echo e($user->nama_lengkap); ?></div>
                <div class="user-email"><?php echo e($user->email); ?></div>

                <input type="file" name="foto" id="foto" accept="image/*" style="display: none;" onchange="previewPhoto(this)">
                ...
                <p class="help-text" style="margin-top: 1rem; text-align: left;">
                ...
                <div class="form-card">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="alamat" 
                                  ...
                                  required><?php echo e(old('alamat', $user->alamat)); ?></textarea>
                    ...
                    <div class="input-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   value="<?php echo e(old('alamat_balai_desa', $user->alamat_balai_desa)); ?>"
                                   class="form-input"
                                   placeholder="Untuk pengambilan pupuk/bibit subsidi">
                            <?php $__errorArgs = ['alamat_balai_desa'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   id="kabupaten" 
                                   name="kabupaten" 
                                   value="<?php echo e(old('kabupaten', $user->kabupaten)); ?>"
                                   class="form-input"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" 
                               id="kode_pos" 
                               name="kode_pos" 
                               value="<?php echo e(old('kode_pos', $user->kode_pos)); ?>"
                               maxlength="5"
                               class="form-input"
                               placeholder="12345">
                    ...
                    <div class="input-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   id="luas_lahan" 
                                   name="luas_lahan" 
                                   value="<?php echo e(old('luas_lahan', $user->luas_lahan)); ?>"
                                   step="0.01"
                                   min="0"
                                   class="form-input"
                                   placeholder="Contoh: 2.5">
                            <p class="help-text">Masukkan luas lahan dalam hektar (contoh: 2.5 ha)</p>
                            <?php $__errorArgs = ['luas_lahan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-actions">
                    <a href="<?php echo e(route('profil.user')); ?>" class="btn btn-cancel">
...
<script>
    ...
    function removeFoto() {
        if (confirm('Apakah Anda yakin ingin menghapus foto profil?')) {
            ...
            const preview = document.getElementById('photoPreview');
            const userName = '<?php echo e($user->nama_lengkap); ?>';
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ppw10\Project-SistemInformasiPupuk\resources\views/user/EditProfil.blade.php ENDPATH**/ ?>
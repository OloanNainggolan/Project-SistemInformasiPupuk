<?php $__env->startSection('title', 'Edit Profil Admin - Pupuk & Bibit Subsidi'); ?>
        ...
        <form action="<?php echo e(route('admin.profil.update')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-input" value="<?php echo e(old('name', session('admin_name', 'Administrator Sistem'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="username" class="form-input" value="<?php echo e(session('admin_username', 'admin')); ?>" disabled>
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" class="form-input" value="<?php echo e(old('email', session('admin_email', 'admin@pupuksubsidi.id'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="tel" name="phone" class="form-input" value="<?php echo e(old('phone', session('admin_phone', '+62 812-3456-7890'))); ?>" placeholder="+62 xxx-xxxx-xxxx">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <textarea name="address" class="form-input" placeholder="Masukkan alamat lengkap"><?php echo e(old('address', session('admin_address', 'Jl. Sitoluama, Laguboti, Toba Samosir'))); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-actions">
                ...
                <a href="<?php echo e(route('admin.profil')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ppw\resources\views/admin/profil-edit.blade.php ENDPATH**/ ?>
...
<div class="notifications-container">
    ...
    <div class="page-header">
        ...
        <div class="header-stats">
            <span class="stat-badge">
                ...
                Total: <strong><?php echo e($notifications->total()); ?></strong>
            </span>
            <?php if($unreadCount > 0): ?>
            <span class="stat-badge unread">
                <i class="fas fa-envelope-open"></i>
                Belum Dibaca: <strong><?php echo e($unreadCount); ?></strong>
            </span>
            <form action="<?php echo e(route('user.notifications.markAllRead')); ?>" method="POST" style="display: inline;">
                <?php echo csrf_field(); ?>
    ...
    <div class="messages-list">
        ...
        <div class="message-card type-message <?php echo e($isUnread ? 'unread' : ''); ?>" data-message-id="<?php echo e($item->id); ?>">
            <a href="<?php echo e(route('notifikasi.show', $item->id)); ?>" class="message-link">
                <div class="message-header">
                    <div class="sender-info">
                        <?php if(Auth::user()->photo_profile): ?>
                            <img src="<?php echo e(asset('images/profiles/' . Auth::user()->photo_profile)); ?>" alt="<?php echo e(Auth::user()->name); ?>" class="sender-avatar-img user" onerror="this.onerror=null; this.style.display='none'; this.nextElementSibling.style.display='flex';">
                        <?php endif; ?>
                        <div class="sender-avatar user" style="<?php echo e(Auth::user()->photo_profile ? 'display:none;' : ''); ?>">
                        ...
                        <div class="sender-details">
                            ...
                            <div class="message-date">
                                ...
                                Terakhir: <?php echo e($lastActivity->diffForHumans()); ?>
                ...
                <div class="message-subject">
                    ...
                    <?php if($item->sender_type === 'admin' && $item->priority): ?>
                        <span class="priority-badge priority-<?php echo e($item->priority); ?>">
                            ...
                            <?php elseif($item->priority === 'normal'): ?>
                ...
                <div class="message-preview">
                    <?php if($item->replies->count() > 0): ?>
                        <?php
                            $lastReply = $item->replies->last();
                            $lastSender = $lastReply->sender_type === 'admin' ? 'Admin' : 'Anda';
                        ?>
                        <span class="preview-sender <?php echo e($lastReply->sender_type); ?>"><?php echo e($lastSender); ?>:</span> 
                        <?php echo e(Str::limit($lastReply->message, 100)); ?>

                    <?php else: ?>
                        <?php
                            $originalSender = $item->sender_type === 'admin' ? 'Admin' : 'Anda';
                        ?>
                        <span class="preview-sender <?php echo e($item->sender_type); ?>"><?php echo e($originalSender); ?>:</span>
                        <?php echo e(Str::limit($item->message, 120)); ?>
                ...
                <div class="message-footer">
                    <span class="reply-count">
                        ...
                        <?php echo e($item->replies->count() + 1); ?> Pesan
                    </span>
                    <?php if($item->replies->count() > 0): ?>
            ...
            <div class="message-actions" onclick="event.stopPropagation()">
                <?php if($isUnread): ?>
                <button class="action-btn mark-read" onclick="markAsRead(<?php echo e($item->id); ?>)" title="Tandai Dibaca">
                    <i class="fas fa-check"></i>
                </button>
                <?php endif; ?>
                <button class="action-btn delete" onclick="deleteMessage(<?php echo e($item->id); ?>)" title="Hapus Thread">
        ...
        <div class="message-card type-notification <?php echo e($isUnread ? 'unread' : ''); ?>" data-notification-id="<?php echo e($item->id); ?>">
            <a href="<?php echo e(route('notifikasi.show', $item->id)); ?>" class="message-link">
                <div class="message-header">
                    <div class="sender-info">
                ...
                <div class="message-subject">
                    ...
                    <?php elseif($item->type === 'important'): ?>
                        <i class="fas fa-exclamation-circle" style="color: #ef4444; margin-right: 5px;"></i>
                    <?php endif; ?>
                    <?php echo e($item->title); ?>

                    <span class="priority-badge priority-<?php echo e($item->type === 'important' ? 'urgent' : 'normal'); ?>" style="background: 
                        <?php if($item->type === 'info'): ?> #dbeafe; color: #1e40af;
                        <?php elseif($item->type === 'success'): ?> #d1fae5; color: #065f46;
                        <?php elseif($item->type === 'warning'): ?> #fed7aa; color: #92400e;
                        <?php elseif($item->type === 'important'): ?> #fee2e2; color: #991b1b;
                        <?php endif; ?>
                        ">
                        <?php if($item->type === 'info'): ?>
                            <i class="fas fa-minus"></i> NORMAL
                ...
                <div class="message-preview">
                    ...
                    <?php echo e(Str::limit($item->title, 100)); ?>
            ...
            <div class="message-actions" onclick="event.stopPropagation()">
                <?php if($isUnread): ?>
                <button class="action-btn mark-read" onclick="markNotificationAsRead(<?php echo e($item->id); ?>)" title="Tandai Dibaca">
                    <i class="fas fa-check"></i>
                </button>
                <?php endif; ?>
                <button class="action-btn delete" onclick="deleteNotification(<?php echo e($item->id); ?>)" title="Hapus Notifikasi">
                    <i class="fas fa-trash-alt"></i>
                </button>
            </div>
        </div>
    ...
    <div class="empty-state">
        ...
        <a href="<?php echo e(route('kontak')); ?>" class="btn-contact">
            <i class="fas fa-paper-plane"></i>
            Hubungi Admin
        </a>
    </div>
...
function showNotificationDetail(notificationId) {
    ...
    const notifications = <?php echo json_encode($notifications->items(), 15, 512) ?>;
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ppw10\Project-SistemInformasiPupuk\resources\views/user/notifications/index.blade.php ENDPATH**/ ?>
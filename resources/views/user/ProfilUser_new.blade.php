                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="font-medium text-gray-900">122456</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="font-medium text-gray-900">bali</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="font-medium text-gray-900">December 2025</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="bg-purple-50 rounded-lg p-4 text-center">
                        ...
                        <p class="text-lg font-bold text-gray-900">Rp 1.000</p>
                ...
                <table class="w-full">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr class="hover:bg-gray-50 transition duration-150">
                            <td class="px-6 py-4">
                                <p class="text-sm font-semibold text-gray-900">ORD-20251208-E1E946</p>
                                <p class="text-xs text-gray-500">Produk tidak tersedia</p>
                            </td>

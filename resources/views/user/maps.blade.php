...
@section('title', 'Lokasi Pengambilan Pesanan')
        ...
        <div class="info-card">
            ...
            <div class="order-info">
                ...
                <div class="order-info-item">
                    ...
                    <span class="order-info-value">{{ $order->quantity }} kg</span>
                </div>
            </div>
            ...
            <div class="pickup-info">
                ...
                <div class="pickup-name">{{ $nearestPoint->name }}</div>
            ...
            <div class="action-buttons">
                <a href="https://www.google.com/maps/dir/?api=1&origin={{ $userLatitude }},{{ $userLongitude }}&destination={{ $nearestPoint->latitude }},{{ $nearestPoint->longitude }}&travelmode=driving" 
                   target="_blank" 
...
@push('scripts')
<script src="https://maps.googleapis.com/maps/api/js?key={{ env('GOOGLE_MAPS_KEY') }}&libraries=places,geometry"></script>
<script>
    let map;
    let userMarker;
    let nearestMarker;
    ...
    const allPickupPoints = @json($allPickupPoints);
        ...
        if (navigator.geolocation) {
            ...
            navigator.geolocation.getCurrentPosition(
                (position) => {
                    ...
                    window.location.href = `{{ route('maps.show') }}?order={{ $order->order_number }}&lat=${lat}&lng=${lng}`;
                },
                (error) => {

    ...
    <div class="register-wrapper">
        ...
        <div class="register-right">
            ...
            <form method="POST" action="{{ route('register.process') }}" id="registerForm">
                ...
                <a href="{{ route('auth.google') }}" class="btn-submit" role="button" aria-label="Daftar atau masuk dengan Google" style="display:inline-flex;align-items:center;justify-content:center;text-decoration:none;">
                    <i class="fas fa-user-plus"></i> Daftar / Masuk dengan Google
                </a>

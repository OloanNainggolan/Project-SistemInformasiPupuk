...
class AuthController extends Controller
{
    ...
    public function showProfil()
    {
        ...
        // Hitung total pupuk dan bibit dari semua pesanan
        $pupukDiterima = 0;
        $bibitDiterima = 0;
        $totalPenghematan = 0;
        ...
        foreach ($orders as $order) {
            ...
            $totalPenghematan += $order->discount_amount ?? 0;
            
            // Hitung semua pupuk/bibit yang dipesan (tidak hanya yang completed)
            if ($order->product) {
